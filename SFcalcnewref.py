...
if __name__ =="__main__":
  #Only change 3 things  1) Output file name 2) Well inventory Directory 3) Planned Wells Directory
  #1 change output file_name

  out_put_file_name = 'test.xlsx'
  #2 Change Well Inventory File Location
  wellsfile = 'xxx'
  #3 Change Planned Wells File Location
  planned_well_file_location = 'xxx'
